...
def test_bbox_coordinates(dataset_img_dir, dataset_dir):
    """ Test if the provided bbox coordinates are within the image size """
...
def test_if_category_in_range(dataset_dir):
...
def test_img_type(dataset_img_dir):
...
def test_num_processed_objects(dataset_dir, dataset_img_dir):
...
def test_get_dataset_paths():
    ...
    expected_result = [{'name': 'human_dataset', 'dataset_dir': '/Users/todo/PycharmProjects/Tenyks/dataset_data/human_dataset',
...
def test_generate_dataset_info():
    ...
    test_result = Processor.generate_dataset_info("human_dataset",
                                                  "/Users/todo/PycharmProjects/Tenyks/dataset_data/human_dataset/",
                                                  "/Users/todo/PycharmProjects/Tenyks/dataset_data/human_dataset/images")
    assert test_result[0].data() == {'name': 'human_dataset', 'size': 12, 'type': '.jpg'}


def test_generate_model_info():
    """ Test the generate_model_info function for expected output"""
    test_result = Processor.generate_model_info("/Users/todo/PycharmProjects/Tenyks/dataset_data/human_dataset/")

    assert test_result[0].data() == {'name': 'Hybrid Model', 'id': ['human_dataset', 'terminator_dataset'], 'datasets': 0}
...
def test_generate_image_info():
    ...
    test_result = Processor.generate_image_info("/Users/todo/PycharmProjects/Tenyks/dataset_data/human_dataset/", 0)
