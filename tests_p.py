...
def test_load_img_bbox():
    ...
    test_bbox = LoadImgMetadata("11.jpg", dataset_dir).load_img_bbox()
...
def test_load_img_category():
    ...
    test_category = LoadImgMetadata("11.jpg", dataset_dir).load_img_category()
...
def test_generate_image_info():
    ...
    test_result = Processor.generate_image_info(dataset_dir, 0)
